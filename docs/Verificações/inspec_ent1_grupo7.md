...
|---------------------|---------------------------------------------------------------------------|----------------------------------|
| 1 – Uma página apresentando os integrantes da equipe (com foto) com nome e sem matrícula? | Conforme | 10/09 20:39 |
| 2 - O cronograma do planejamento apresenta todas as atividades de todas as etapas para cada integrante com as datas de início e fim das entregas dos artefatos e com o período da revisão deles? | Conforme | 10/09 20:39 |
| 3 - O cronograma do planejamento apresenta um período de gravação da apresentação de cada etapa. | Conforme | 10/09 20:39 |
| 4 - O cronograma prevê um período de revisão/ajustes nos artefatos devidos as considerações dos monitores/professor? | Conforme | 10/09 20:39 |
| 5 - O cronograma prevê **cada uma das técnicas de elicitação** de requisitos que serão usadas no projeto? | Conforme | 10/09 20:39 |
| 6 - O cronograma prevê **cada uma das técnicas de priorização** de requisitos que serão usadas no projeto? | Conforme, com ressalvas | 10/09 20:39 |
| 7 - A motivação e os critérios para a escolha do App? | Não Conforme | 10/09 20:39 |
| 8 - Cópia do Termo de Uso, Direito de Uso ou Propriedade Intelectual do aplicativo permitindo o estudo na disciplina. | Conforme | 10/09 20:39 |
| 9 - Possui opção de contraste de cores? | Conforme | 10/09 20:39 |
| 10 - Uma página com as atas de reunião com o acesso a gravação (vídeo), quando houver. | Conforme | 10/09 20:39 |
...
|---------------------------------------|---------------------------------------------------------------------------|----------------------------------|
| 1 - O histórico de versão padronizado? | Não Conforme | 10/09 19:00 |
| 2 – O(s) autor(es) e o(s) revisor(es) para cada artefato? | Conforme | 10/09 19:00 |
| 3 - Referências bibliográficas e/ou bibliografia em todos os artefatos? | Conforme | 10/09 19:00 |
| 4 - As tabelas e imagens possuem legenda e fonte e elas chamadas dentro dos texto? | Não Conforme | 10/09 19:00 |
| 5 - Um texto fazendo uma introdução dos artefatos? | Conforme | 10/09 19:00 |
| 6 - O cronograma executado com quem realizou cada artefato/atividade com as datas de início e fim da construção/realização do artefato/atividade. | Conforme | 10/09 19:00 |
| 7 - Ata(s) da(s) reuniões (com data, horário de início e do final, participantes, objetivo, atividades definidas etc). | Conforme | 10/09 19:00 |
| 8 – A gravação da reunião do grupo. | Conforme | 10/09 19:00 |
| 9 - Vídeo de apresentação na categoria “não listado” no youtube? | Conforme | 10/09 19:00 |
| 10 - Tabela de contribuição no início do artefato com o nome de todos os integrantes com a contribuição de cada integrante com hiperligação atividade e da gravação, se houver. | Conforme | 10/09 19:00 |

<font size="2"><p style="text-align: center"><b>Tabela 2</b> - Lista de verificação Desenvolvimento do projeto. </p></font>
 
| Itens do Desenvolvimento do projeto. | Avaliação (Conforme / Não Conforme / Não aplicável/ Sugestão de Melhoria) | Versão, Data e hora da avaliação |
|--------------------------------------|---------------------------------------------------------------------------|----------------------------------|
| 1 - O rich picture está sendo usado para analisar problemas e expressar ideias? | Conforme | 20:39 - 09/09 |
| 2 - Os principais stakeholders estão sendo representados no rich picture? | Não Conforme | 20:39 - 09/09 |
| 3 - O rich picture identifica as questões ou preocupações dos stakeholders? | Não Conforme | 20:39 - 09/09 |
| 4 - Para cada ator está identificado as operações que eles precisam realizar? | Conforme | 20:39 - 09/09 |
| 5 - Os autores estão identificados no domínio do problema? | Não Conforme | 20:39 - 09/09 |
| 6 - O limite do sistema está desenhado para definir sua área de responsabilidade? | Conforme | 20:39 - 09/09 |
| 7 - O rich picture comunica uma mensagem clara e compreensível sobre o funcionamento do sistema? | Conforme | 20:39 - 09/09 |
| 8 - As operações descritas no rich picture representam funcionalidades do sistema e são executadas por atores ou por outras operações? | Conforme | 20:39 - 09/09 |
