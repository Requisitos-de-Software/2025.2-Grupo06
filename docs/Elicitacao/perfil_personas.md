...
Foram elaboradas cinco personas com base no perfil de usuário: duas primárias, uma secundária, uma ocasional e uma antipersona. A escolha dessa quantidade buscou representar diferentes características sem perder o foco nos perfis principais. As imagens das personas foram geradas com a ferramenta <a href="https://this-person-does-not-exist.com/pt"><i>This Person Doesn't Exist</i></a> para criar representações visuais fictícias das personas.
...
### Tabela 1 - Persona Primária: Juliana Ferreira Monteiro
...
| **Nome**: Juliana Ferreira Monteiro |
|-------------------------------------|
| **Status**: Persona Primária |
| **Gênero**: Feminino |
| **Idade**: 23 anos |
| **Profissão**: Estudante de Ciência da Computação |
| **Escolaridade**: Graduação em andamento em Ciência da Computação |
| **Habilidades e Experiências**: Familiaridade com tecnologia, aplicativos móveis e organização de rotinas acadêmicas. Está acostumada a usar apps para estudo, transporte e produtividade. |
| **Relacionamento**: Colegas da universidade, professores, amigos próximos e familiares. |
| **Objetivo**: Facilitar o deslocamento diário até a universidade e outros compromissos, evitando atrasos e longas esperas nos pontos de ônibus, utilizando o aplicativo para consultar em tempo real os horários e itinerários das linhas. |
| **Expectativa**: Ter acesso rápido e confiável aos horários dos ônibus, com notificações de chegada e informações sobre possíveis atrasos, para poder planejar sua rotina acadêmica e social sem estresse. |
| **Requisitos**: O aplicativo deve mostrar os horários atualizados, permitir salvar linhas favoritas, avisar sobre mudanças no itinerário e oferecer uma interface simples e intuitiva. |
| **Tarefas**: Acordar cedo para ir à universidade, assistir às aulas, estudar na biblioteca ou laboratórios, encontrar amigos, voltar para casa de ônibus e, à noite, revisar conteúdos ou usar aplicativos de lazer. |
...
| 2.0   | 22/11/2025 | Adiciona agradecimentos  | [Cauã Nicolas](https://github.com/cauanicolas)  | [João Ramos](https://github.com/Joaolramos) |
