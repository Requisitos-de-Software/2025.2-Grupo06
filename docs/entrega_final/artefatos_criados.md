...
Este documento reúne os principais artefatos desenvolvidos em cada etapa do projeto, destacando o vínculo com a documentação em Markdown, uma breve descrição e os responsáveis por autoria e revisão.

## Etapa 1 — Planejamento e Pré-Rastreabilidade

| **Artefato** | **Descrição** | **Autor(es)** | **Revisor(es)** |
| --- | --- | --- | --- |
| [Aplicativo escolhido](../Planejamento/Aplicativoescolhido.md) | Panorama do DF no Ponto, comparação com apps avaliados e justificativa da escolha. | Daniel Nunes Duarte | Cauã Nicolas |
| [Cronograma detalhado](../Planejamento/Cronogramadetalhado.md) | Cronograma macro e por etapa com datas, responsáveis e marcos. | Gabriel Maciel | Cauã Nicolas |
| [Ferramentas utilizadas](../Planejamento/Ferramentasuti.md) | Catálogo das ferramentas de comunicação, edição, versionamento e apoio com IA. | Fernanda Vaz; João Ramos; João Gabriel; Gabriel Maciel | Fernanda Vaz; João Ramos |
| [Heatmap de disponibilidade](../Planejamento/Heatmap.md) | Mapa de calor com os horários de maior disponibilidade da equipe. | Fernanda Vaz | Gabriel Maciel |
| [Rich Picture](../pre-rastreabilidade/rich_picture.md) | Visão sistêmica dos atores, fluxos e dores do DF no Ponto. | Cauã Nicolas; João Gabriel | Cauã Nicolas |

*Tabela 1: Artefatos da Etapa 1 — Planejamento e Pré-Rastreabilidade - Fonte: Fernanda Vaz, 2025*
...
| [Priorização $100 Dollars](../Elicitacao/priorizacao_100_dollars.md) | Ranking colaborativo via orçamento fictício distribuído entre requisitos. | João Gabriel; Gabriel Maciel | Gabriel Maciel; João Gabriel |

*Tabela 2: Artefatos da Etapa 2 — Elicitação e Priorização - Fonte: Fernanda Vaz, 2025*

## Etapa 3 — Modelagem Clássica

| **Artefato** | **Descrição** | **Autor(es)** | **Revisor(es)** |
| --- | --- | --- | --- |
| [Casos de uso](../modelagem_requisitos_01/casos_de_uso.md) | Modelo UC01–UC12 com tabelas completas de fluxos, exceções e rastreabilidade. | Gabriel Maciel; Fernanda Vaz; Cauã Nicolas; João Ramos; João Gabriel; Daniel Nunes Duarte | Fernanda Vaz; Gabriel Maciel; Cauã Nicolas |
| [Cenários](../modelagem_requisitos_01/cenarios.md) | Cenários narrativos validados em vídeo cobrindo o ciclo ponta a ponta dos usuários. | Gabriel Maciel; Fernanda Vaz; João Ramos; Cauã Nicolas; João Gabriel; Daniel Nunes Duarte | Fernanda Vaz; Gabriel Maciel; João Ramos; Cauã Nicolas (versões 1.9–2.1 aguardam revisão) |
| [Léxicos](../modelagem_requisitos_01/lexicos.md) | Léxicos 1–18 com validação e relações semânticas para o domínio DF no Ponto. | Gabriel Maciel; Fernanda Vaz; Cauã Nicolas; João Gabriel; João Ramos; Daniel Nunes Duarte | Fernanda Vaz; Gabriel Maciel; João Lucas; João Gabriel; Cauã Nicolas |
| [Especificação suplementar](../modelagem_requisitos_01/especificacao_suplementar.md) | Catálogo de requisitos não funcionais por atributos de qualidade e padrões (LGPD, TLS, OAuth). | Gabriel Maciel; Fernanda Vaz; João Ramos; Daniel Nunes Duarte | Fernanda Vaz; Gabriel Maciel (revisões das versões 1.5+ pendentes) |

*Tabela 3: Artefatos da Etapa 3 — Modelagem Clássica - Fonte: Fernanda Vaz, 2025*
...
*Tabela 5: Artefatos da Etapa 5 — Validação e Verificação - Fonte: Fernanda Vaz, 2025*

## Etapa 6 — Pós-Rastreabilidade

| **Artefato** | **Descrição** | **Autor(es)** | **Revisor(es)** |
| --- | --- | --- | --- |
| [Backward-from](../pos-rastreabilidade/backward.md) | Liga requisitos aos artefatos produzidos, classificando fontes e tipos de elo. | Gabriel Maciel; Fernanda Vaz; João Gabriel; João Ramos; Daniel Nunes Duarte | Cauã Nicolas; Gabriel Maciel; João Ramos |
| [Forward-from](../pos-rastreabilidade/forward.md) | Rastreia requisitos até épicos, histórias, léxicos e modelos posteriores. | Gabriel Maciel; João Gabriel; João Ramos; Cauã Nicolas; Daniel Nunes Duarte | Fernanda Vaz; Gabriel Maciel; Cauã Nicolas; João Ramos |
